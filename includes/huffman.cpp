...
bool initialize_huffman_window()
{
  ...
  // SDL_SetRenderDrawBlendMode(huffman_window::renderer, SDL_BLENDMODE_BLEND);
  //  set the color
  SDL_SetRenderDrawColor(huffman_window::renderer, 0, 128, 128, 0);

  // set the entire screen to that color
