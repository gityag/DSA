...
object_files=$(build_dir)/main.o \
							$(build_dir)/circle.o $(build_dir)/line.o \
							$(build_dir)/huffman.o $(build_dir)/huffman_data_structure.o \
							$(build_dir)/huffman_maths.o $(build_dir)/dijkstras.o
...
$(build_dir)/main.o: main.cpp ./includes/huffman.* ./includes/dijkstras.*
	$(co) main.cpp -o $@
...
$(build_dir)/dijkstras.o: ./includes/dijkstras.* 
	$(co) ./includes/dijkstras.cpp -o $@
